 ...
 *
 * Adds the class name `web-gl` to the canvas to allow for custom styling with CSS.
 *
...
/**
 * Represents a WebGL renderer responsible for rendering the scenes onto the canvas.
 *
...
/**
 * Represents an OrbitControls instance used for controlling the camera.
 *
 * @see https://threejs.org/docs/#examples/en/controls/OrbitControls
 */
export const controls = new OrbitControls(camera, canvas);
export { canvas, scene, camera, renderer, clock };
